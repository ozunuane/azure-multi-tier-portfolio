...
# helm upgrade --install $NGINX_INGRESS_RELEASE_NAME_EXTERNAL ingress-nginx/ingress-nginx \
#   --namespace $NAMESPACE \
...
# # Install NGINX Ingress Controller as an internal ingress
# helm upgrade --install $NGINX_INGRESS_RELEASE_NAME_INTERNAL ingress-nginx/ingress-nginx \
#   --namespace $NAMESPACE \
#   --set controller.replicaCount=2 \
#   --set controller.nodeSelector."kubernetes\\.io/os"=linux \
#   --set defaultBackend.nodeSelector."kubernetes\\.io/os"=linux \
...
# kubectl rollout status deployment/$NGINX_INGRESS_RELEASE_NAME_EXTERNAL-controller -n $NAMESPACE || { echo "❌ NGINX Ingress installation failed"; exit 1; }
# kubectl rollout status deployment/$NGINX_INGRESS_RELEASE_NAME_INTERNAL-controller -n $NAMESPACE || { echo "❌ NGINX Ingress installation failed"; exit 1; }
